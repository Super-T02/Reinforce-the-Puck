...
# Load CSV data
predtrained_and_no_ft = pd.read_csv(
    "data/loss_moe_no_expert_training_stable_report_2025-02-22_09-02-20_100.csv"
)
from_scratch = pd.read_csv(
    "data/loss_moe_empty_agents_stable_report_2025-02-22_09-02-24_100.csv"
)
from_scratch = from_scratch.sort_values(by="Step")
...
pretrained_and_ft = pd.read_csv(
    "data/loss_moe_pretrained_and_expert_training_stable_report_2025-02-22_09-02-01_100.csv"
)
