...
def create_agent_from_checkpoint(
    path, agent_type, observation_space: spaces.box.Box, action_space: spaces.box.Box
) -> BaseAgent:
    """
...
def create_agent_from_config(
    config: AgentConfig, observation_space: spaces.box.Box, action_space: spaces.box.Box
) -> BaseAgent:
    """
